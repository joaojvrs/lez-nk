...
const BulletList = ({ items, dark = false }: { items: readonly string[]; dark?: boolean }) => (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <ProjectCard dark delay={0.1}>
                ...
                <h4 className="font-serif font-bold text-xl mb-3">Blue Lagoon Island Riviera</h4>
                <span className="inline-block text-[8px] font-mono uppercase tracking-widest px-2 py-1 border border-gold/30 text-gold/60 mb-4">
                  {p.s02.rivieraBadge}
                </span>
                <BulletList
                  dark
                  items={p.s02.rivieraItems}
                />
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-14 items-start">
            ...
            >
              ...
              <div className="p-6 glass-card tech-border">
                ...
                <BulletList items={p.s05.paymentItems} />
              </div>
            </motion.div>
      ...
      <section className="bg-dark text-white py-16 md:py-32 relative overflow-hidden">
        ...
        <div className="px-6 md:px-12 lg:px-24 max-w-7xl mx-auto relative">
          ...
          >
            ...
            <span className="text-gold text-[10px] font-mono uppercase tracking-[0.2em] md:tracking-[0.4em] font-bold block mb-6">
              {p.positioning.tag}
            </span>
            <h2 className="text-3xl md:text-5xl font-serif font-bold leading-tight tracking-tighter mb-6">
              {p.positioning.title}{" "}
              <span className="gold-gradient">{p.positioning.titleGold}</span>
            </h2>
